...
public class CollectionClient {
    public static void main(String[] args) throws Exception {
        List<Collectable> collection = new List("Hazmat","RoboHodags","Supposable Thumbs", "Patronum Bots", "Viking Robotics", "Men in Kilts", "Great Scott", "Kracken Pinion", "Panicking Coconuts", "The Knack", "Incredible Thumbs", "TBD", "LaserTech", "Robodons","Techno G.O.A.T.S.", "Crimson Crusaders", "Chair Chasers", "Hortonville Robotics", "Kinetic Polar Bears");
        /*collection.add("Hazmat");
        collection.add("RoboHodags");
        collection.add("Supposable Thumbs");
        collection.add("Patronum Bots");
        collection.add("Viking Robotics");
        collection.add("Men in Kilts");
        collection.add("Great Scott");
        collection.add("Kracken Pinion");
        collection.add("Panicking Coconuts");
        collection.add("The Knack");
        collection.add("Incredible Thumbs");
        collection.add("TBD");
        collection.add("LaserTech");
        collection.add("RoboDons");
        collection.add("Techno G.O.A.T.S.");
